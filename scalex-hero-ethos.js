/*! ScaleX hero · self-contained · baked 2026-09-14 14:37 UTC
 *
...
window.__SCALEX_BUILD = "50.n06ckr";
var __SCALEX_BAKED = {"px":2,"levels":7,"lens":600,"lensF":4,"lensOn":true,"lensStr":0.6,"lensFx":{"reveal":true,"brighten":true,"invert":false,"desat":true,"ripple":false,"condense":false},"par":2,"drift":2,"dither":true,"comp":"B","ditherMode":"bayer","dot":1.3,"glow":0,"glowR":0.6,"glowOn":true,"order":"ditherTop","ui":true,"introDur":3.5,"introStagger":0.02,"introEaseIn":2,"introEaseOut":5,"introOffX":0,"introOffY":0,"introOffZ":0,"introSpin":10,"partFan":false,"echoOn":false,"introMode":"fan","introDelay":0,"introSpinX":0,"introSpinY":0,"introScale":1,"introOffX1":0,"introOffY1":0,"introOffZ1":0,"introSpinX1":0,"introSpinY1":0,"introSpin1":10,"introScale1":1,"mouseOn":true,"mMove":0.2,"mScale":0.7,"mRot":0.2,"mDelay":1.32,"mInvert":false,"mZPush":0,"mRoll":0,"mReact":1.4,"mReactR":220,"mCasAmt":1.1,"mCasDelay":0.92,"scrTurn":0,"scrDolly":0,"scrRise":10,"scrDelay":0.01,"scrCas":1,"bScroll":"rotate","bAxis":"z","bRot":0,"bScale":0.6,"grHue":-15,"grSat":0.7,"grBright":1.48,"tintOn":true,"tintA":"#2715b2","tintB":"#2c45aa","tintAmt":1,"tintDesat":1,"tintGain":2,"tintAngle":-15,"gradOn":true,"gradA":"#5451d6","gradB":"#0f145c","gradAngle":157,"gradGain":1.7,"blobOn":true,"blobSize":910,"blobOp":0.18,"blobFeather":60,"gCell":25,"gBase":0.17,"gBright":1.05,"gScale":0.5,"gMaskR":320,"gMaskShape":"x","gVig":1,"gVigR":0.48,"gXRotate":0,"gIntroDur":1.8,"gEaseIn":2,"gEaseOut":4,"gIntroDir":"centerOut","gExpandOn":true,"gExpandFrom":0.35,"gExpandDur":1.6,"gMoveMode":"off","gMoveAmt":2,"gMoveDur":1.6,"gridOn":true,"gPostSep":true,"gMouseOn":true,"gDitherMode":"off","gPx":3,"gLevels":6,"gDot":1.3,"gTeaseOn":false,"gIntroAt":0,"gSwpAt":0.2,"gSwpDur":1.2,"gSwpGain":0.9,"gSwpAng":0,"gSwpWide":0.16,"gSwpSoft":1,"gSwpRegion":"all","gSwpTravel":1.3,"gGlimpseAt":1.6,"gGlimpseDur":0.9,"gGlimpseStr":1,"gLeakAt":0,"gLeakDur":2.4,"gLeakGain":0.35,"gLeakAng":90,"gLeakWide":0.7,"gLeakTravel":0.6,"gXFrom":0.3,"gXSpin":0,"gIntroMode":"pop","gStagger":0.5,"gTrail":0,"gFieldX":0,"gFieldY":0,"gMaskOffX":0,"gMaskOffY":0,"gEaseMode":"power","gC1x":0.42,"gC1y":0,"gC2x":0.58,"gC2y":1,"gMEaseMode":"power","gMC1x":0.42,"gMC1y":0,"gMC2x":0.58,"gMC2y":1,"gTileOffX":0,"gTileOffY":0,"gTileSpin":0,"gTileScale":0.4,"gTileFade":0,"gTileOffX1":0,"gTileOffY1":0,"gTileSpin1":0,"gTileScale1":0.4,"gTileFade1":0,"gRot":0,"gMRot":0,"gGap":0.24,"gTileSc":1.45,"gXSize":5,"gXFeather":0.36,"gMaskOp":0,"gGridOpIn":1,"gGridOpOut":1,"gWaveOn":false,"gWaveAmp":8,"gWaveFreq":1.6,"gWaveSpeed":1,"gWaveCursor":false,"gPushOn":false,"gPushAmt":30,"gGradOn":true,"gGradA":"#6b6cff","gGradB":"#6b6cff","gGradAngle":-35,"gGradGain":1,"gScrOn":true,"gScrSlide":120,"gScrMask":0.5,"gScrFade":0.15,"gScrGlow":1.8,"gScrEase":1.4,"gPTrig":"off","gPFrom":"mask","gPShape":"round","gPRegion":"all","gPSpeed":12,"gPWidth":3,"gPThick":87,"gPFadeIn":0,"gPFadeOut":1,"gPStart":0,"gPBirth":"center","gPRot":0,"gPAnchorX":0.5,"gPAnchorY":0.5,"gPAnchorOn":true,"gPDilOn":false,"gPDilate":0.5,"gPGainIn":0,"gPGainOut":0,"gPFeathO":1,"gPFeathI":1,"gPHead":0.9,"gPCol":"#a78bfa","gPReach":0.8,"gPGrow":0.6,"gPHue":0.8,"gPLife":1.6,"gPFirst":1.2,"gPAuto":4.5,"gPAutoStr":0.7,"gQOn":false,"gQSteps":6,"gPar":0,"gScaleM":0.005,"gSphere":0,"gDelay":0.3,"gMaskDelay":0.52,"gMaskEase":false,"gRevealDur":0.55,"gRevealDelay":4,"gRevealEase":1,"gRevealMode":"fade","gMouseMode":"parallax","gParAmt":0,"gXFade":1,"gMaskAX":0.5,"gMaskAY":0.5,"gMaskAnchorOn":true,"iters":6,"s0":1.2,"s1":2,"p0x":-1.956,"p0y":0.003,"p0z":-1.523,"p1x":-7.85,"p1y":-2.9,"p1z":1.25,"r0x":7,"r0y":32,"r0z":-11,"r1x":0,"r1y":1,"r1z":33,"delayD":3,"delayS":0.13,"skew":0,"stx":1,"sty":0.8,"frontFade":0,"opMul":2.2,"tintHold":0.6};
...
(() => {
  ...
  const __sxMinted = !document.getElementById('stage');
  if (__sxMinted){
    const el = document.createElement('div');
    el.id = 'stage';
    root.insertBefore(el, root.firstChild);       // behind everything: z-index 0, fixed
  }
  // only style a stage we minted: when the page supplies #stage, the page owns its layout
  if (__sxMinted && !document.getElementById('scalex-stage-css') && document.head){
...
const P = Object.assign({
  ...
  gVig:1.0, gVigR:0.3, gXRotate:0, gIntroDur:3, gEaseIn:2, gEaseOut:2, gIntroDir:'centerOut', gExpandOn:true, gExpandFrom:0.65, gExpandDur:1.6, gMoveMode:'off', gMoveAmt:2, gMoveDur:1.6,
  ...
  gTeaseOn:false, gIntroAt:0,
  gSwpAt:0.2, gSwpDur:1.2, gSwpGain:0.9, gSwpAng:0, gSwpWide:0.16, gSwpSoft:1, gSwpRegion:'all', gSwpTravel:1.3,
...
const LOOK_KEYS = ['ditherMode','px','levels','dot','glow','glowR','glowOn','order',
  ...
  'gridOn','gPostSep','gMouseOn','gDitherMode','gPx','gLevels','gDot','gTeaseOn','gIntroAt','gSwpAt','gSwpDur','gSwpGain','gSwpAng','gSwpWide','gSwpSoft','gSwpRegion','gSwpTravel',
...
const gridMat = new THREE.ShaderMaterial({
  uniforms: {
    ...
    uSwpSoft:{ value: 1 },           // edge softness multiplier
  ...
  fragmentShader: `
    ...
    void main(){
      ...
      if (uSwpGain > 0.0001 || uLeakGain > 0.0001){
        ...
        if (uSwpGain > 0.0001){
          vec2 d = vec2(cos(uSwpAng), sin(uSwpAng));
          float t = dot(c2, d) / span + 0.5;                      // 0..1 along the axis
          float w = max(0.004, uSwpWide);
          float b = 1.0 - smoothstep(0.0, w * max(0.05, uSwpSoft), abs(t - uSwpPos));
...
bind('uGIntroAt','gIntroAt'); bind('uGSwpAt','gSwpAt'); bind('uGSwpDur','gSwpDur'); bind('uGSwpGain','gSwpGain');
...
if ($('gIntroSeg')){
  ...
  ['gMoveSeg','gMoveSeg2'].forEach(id => {
    if ($(id)) $(id).addEventListener('click', e => {
      ...
      paintMove();
  setChk('uGTeaseOn', P.gTeaseOn); setChk('uGridOn', P.gridOn); setChk('uGPostSep', P.gPostSep); setChk('uGMouseOn', P.gMouseOn); applyGridBgClass();
...
function cookWebflow(){
  ...
  if (note) note.textContent = 'baked ' + WF_JS_NAME + ' (' + Math.round(engine.length / 1024)
    + ' kb, params included, build ' + BUILD + '). one file. paste line on your clipboard.';
}
...
window.SCALEX.cookWebflow = { engine: webflowEngine, testPage: testPageString };
...
function tick(){
  ...
  // render pipeline: [3D scene | X-grid | X-grid UNDER 3D scene] -> rt -> [glow + dither] -> screen
  if (gridLive()){
    ...
    gridMat.uniforms.uSwpPos.value = 0.5 + (ramp(P.gSwpAt, P.gSwpDur) - 0.5) * (P.gSwpTravel === undefined ? 1.3 : P.gSwpTravel);
    ...
    blit(gridMat, (gridUnder() && P.gPostSep) ? gRT : rt);
  }

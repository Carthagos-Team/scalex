/* =========================================================================
   SCALEX — Hero WebGL Background (fractal fly-through) — VARIANTE ALT3
   Arquivo unico: parametros visuais (COOKED_PARAMS) + motor completo.

   Diferenca desta variante pra "fewerX" (base): mesma energia/reatividade
   ao mouse, mas trajetoria de camera e angulo de gradiente diferentes
   (gradAngle 115 vs 157), e menos elevacao vertical no scroll (scrRise 6
   vs 10).
